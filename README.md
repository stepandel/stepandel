...
- 🖥️ [Agentic Compute Store](https://github.com/stepandel/compute-store) - rent temporary Linux machines through agent-native payments.
- 🎙️ [Discovery Calls Co-Pilot](https://github.com/stepandel/sales-co-pilot) - local sales-call co-pilot that suggests better questions in real time.
...
- 🏗️ [Assemblio](https://github.com/stepandel/assemblio) - control plane for fleets of self-modifying AI agents.
